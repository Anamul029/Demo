                    ...
                    <div className="grid  gap-8 grid-cols-3 px-4 md:col-span-2 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 font-semibold">
                                <li>
                                    <a href="#" className=" transition hover:opacity-75">Website monitoring</a>
                                </li>

                                <li>
                                    <a href="#" className=" transition hover:opacity-75">SSL monitoring    </a>
                                </li>

                                <li>
                                    <a href="#" className=" transition hover:opacity-75"> Domain monitoring </a>
                                </li>
